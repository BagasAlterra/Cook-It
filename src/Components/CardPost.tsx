...
const CardPost: FC<CardPostProps> = ({
  ...
  return (
    <div
      className={`w-full bg-base-100 border-2 border-t-0 gap-2 p-4 ${
        deleted ? "hidden" : "flex"
      }`}
    >
      {/* Profile Picture */}
      ...
      <div className="w-10/12">
        ...
        {postPicture !== null ? (
          <div
            onClick={handleToPost}
            className="h-0 pb-2/3 relative hover:cursor-pointer mt-4"
          >
            <img
              src={postPicture}
            ...
            >
              ...
              <li
                ...
                className={`text-error ${
                  profileID == cookies.user.id ? "block" : "hidden"
                }`}
              >
                <p>
                  <MdDeleteForever />
